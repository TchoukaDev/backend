...
export interface ApiClubClub extends Struct.SingleTypeSchema {
  ...
  attributes: {
    animateurs: Schema.Attribute.Component<'shared.media', true>;
...
export interface ApiCompetitionCompetition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    documents: Schema.Attribute.Media<
      ...
      true
    >;
    images: Schema.Attribute.Media<'images' | 'videos' | 'audios', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMarcheAquatiqueMarcheAquatique
  ...
  info: {
    displayName: 'Marche Aquatique';
    pluralName: 'marche-aquatiques';
    singularName: 'marche-aquatique';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    isLicensed: Schema.Attribute.String & Schema.Attribute.Required;
